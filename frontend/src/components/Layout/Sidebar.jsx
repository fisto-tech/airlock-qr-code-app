    ...
    >
      ...
      <div className="flex items-center justify-between p-[1vw] border-b border-slate-700">
        <div className="flex items-center gap-[0.75vw]">
          <div className="w-[2.5vw] h-[2.5vw] rounded-[0.5vw] flex items-center justify-center" style={{ backgroundColor: '#3b82f6' }}>
            <span className="text-[1.2vw] font-bold">QR</span>
          </div>
          <AnimatePresence>
            {isExpanded && (
              <motion.span
                ...
                className="text-[1vw] font-semibold whitespace-nowrap"
              >
                QR Generator
              </motion.span>
            )}
