      ...
      {!fileData?.url ? (
        <>
          ...
          <div className="grid grid-cols-4 gap-[0.5vw]">
            {[
              { type: 'Images', formats: 'PNG, JPG, GIF, WebP, SVG', icon: FiImage },
              { type: 'Videos', formats: 'MP4, WebM, MOV', icon: FiVideo },
              { type: 'Audio', formats: 'MP3, WAV, OGG', icon: FiMusic },
              { type: 'Documents', formats: 'PDF, DOC, PPT', icon: FiFile },
            ].map((item) => (
